            ...
            <main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                <div class="sm:text-center lg:text-left">
                    <h1 class="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                        <span class="block xl:inline">E-Synergy</span><br><br>
                        <span class="block text-indigo-500 xl:inline"><span class="text-red-700 uppercase">d</span>ev<span class="text-red-700 uppercase">o</span>ps / <span class="text-red-700">S</span>RE</span>
                    </h1>
